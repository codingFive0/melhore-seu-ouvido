...
abstract class Model
{
    ...
    {
        if(!$this->required()){
            $this->message->error("Para continuar a ação é necessário o preenchimento de todos os dados.");
            return false;
        }
        ...
        if(!empty($this->id)){
            ...
            if($this->fail()){
                $this->message->error("Erro ao atualizar, confira os dados");
                return false;
            }
        }
        ...
        if(empty($this->id)){
            ...
            if($this->fail()){
                $this->message->error("Erro ao cadastrar, confira os dados");
                return false;
            }
        }
