...
class Online extends Model
{
     ...
     */
    public function __construct(int $sessionTime = INATIVE_TIME)
    {
    ...
    /**
     * @param bool $count
     * @return array|int|mixed|Model|null
     */
    public function findByActive(bool $count = false)
    {
        ...
        return $find->order("updated_at DESC")->fetch(true);
    }
    ...
    public function report(bool $clear = true): Online
    {
        ...
        if(!$session->has("online")){
            ...
            $this->agent = filter_var($_SERVER['HTTP_USER_AGENT']);
